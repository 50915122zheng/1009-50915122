...
const levels = {
    small: {
        size: 2,
        images: ['1.jpg', '2.jpg'] // 2 pairs of images for 2x2 grid
    },
    medium: {
        size: 4,
        images: [
    ...
    large: {
        size: 6,
        images: ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '6.jpg', '7.jpg', '8.jpg',   '18.png', '19.png', '20.png', '21.png', '22.png', '23.png', '24.png', '25.png', '26.png', '27.png'] // 18 pairs for 6x6 grid
    }
};
...
function setBackImage(level) {
    ...
    let backImage = level === 'easy' ? '111.png' : 'flag.jpg'; // 設置不同關卡的反面圖片
